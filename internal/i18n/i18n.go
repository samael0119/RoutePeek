...
var dict = map[string]map[string]string{
	"zh": {
		...
		"cli_iface":                   "显示所有网络接口",
		"cli_check":                   "运行连通性矩阵检查",
		"cli_report":                  "生成可复制的远程排障包",
		"cli_report_format":           "报告格式：markdown 或 json",
		...
		"metric":                      "Metric",
		"public_dns":                  " (公共 DNS)",
		"conn_target_gateway":         "默认网关",
		"conn_target_dns":             "首个 DNS",
		"conn_dns_ip_literal":         "IP 目标，无需 DNS 解析。",
		"conn_dns_failed":             "DNS 解析失败。",
		"conn_dns_ok":                 "解析到 %s。",
		"conn_dns_fake_ip":            "解析到 198.18.0.0/15 fake-IP，通常表示代理 DNS/TUN 接管。",
		"conn_tcp_failed":             "TCP 连接失败。",
		"conn_tcp_ok":                 "TCP 连接 %s 成功。",
		"conn_http_blocked_by_dns":    "DNS 失败，HTTP 无法继续。",
		"conn_http_skipped":           "该目标不是网页探测对象。",
		"conn_http_failed":            "HTTP/HTTPS 探测失败。",
		"conn_http_ok":                "HTTP 探测 %s 成功。",
		"conn_path_timeout":           "路径探测超时。",
		"conn_path_no_gateway":        "未检测到默认网关。",
		"conn_path_gateway":           "目标是当前默认网关。",
		"conn_path_route_probe":       "trace 受限，降级为 route probe；默认出口为 %s。",
		"conn_conclusion_fake_ip":     "检测到代理 Fake-IP/TUN 接管；这是代理虚拟出口，不是目标公网路径。",
		"conn_conclusion_gateway":     "默认网关不可用或缺失；优先检查 Wi-Fi/有线连接、DHCP 和网关配置。",
		"conn_conclusion_dns":         "DNS 失败；检查 DNS 服务器、代理 DNS 或认证门户。",
		"conn_conclusion_tcp":         "TCP 失败；可能是路由、防火墙、代理或目标服务阻断。",
		"conn_conclusion_http":        "TCP 可通但 HTTP 失败；可能是目标站、代理策略、TLS 拦截或 HTTP 状态异常。",
		"conn_conclusion_route_probe": "基础连通性可用；trace 已降级为 route probe，因此只能确认出口选择和端口可达性。",
		"conn_conclusion_ok":          "连通性正常。",
		"conn_conclusion_regional":    "国内目标可达但海外目标不可达；重点检查代理规则、国际出口、DNS 污染或运营商限制。",
		"conn_summary_ok":             "连通性矩阵未发现明显问题。",
		"conn_summary_warning":        "连通性矩阵发现 %d 个需要关注的目标。",
		"conn_summary_danger":         "连通性矩阵发现 %d 个不可达目标。",
		"report_title":                "RoutePeek 远程排障包",
		"report_version":              "版本",
		"report_generated":            "生成时间",
		"report_redaction":            "脱敏",
		"report_redaction_note":       "已隐藏 MAC 地址，去除代理认证信息，并对内网 IP 做部分遮蔽；公网 IP 会保留用于判断出口。",
		"report_sensitive_warning":    "请在发送前检查公网 IP、网卡名称、代理地址、VPN 名称等信息是否敏感。",
		"report_health":               "健康摘要",
		"report_status":               "状态",
		"report_summary":              "摘要",
		"report_primary_issue":        "首要问题",
		"report_first_advice":         "首要建议",
		"report_network_state":        "关键网络状态",
		"report_gateway":              "默认网关",
		"report_public_ip":            "公网 IP",
		"report_proxy":                "代理",
		"report_connectivity":         "连通性矩阵",
		"report_target":               "目标",
		"report_path":                 "路径",
		"report_conclusion":           "结论",
		"report_findings":             "诊断发现",
		"report_no_findings":          "未发现诊断问题。",
		"report_redaction_title":      "脱敏说明",
		"report_empty":                "未获取",
		"report_on":                   "开启",
		"report_off":                  "关闭",
	},
	"en": {
		...
		"cli_check":                   "Run connectivity matrix checks",
		"cli_report":                  "Generate a copyable remote troubleshooting package",
		"cli_report_format":           "Report format: markdown or json",
		...
		"conn_target_gateway":         "Default gateway",
		"conn_target_dns":             "First DNS",
		"conn_dns_ip_literal":         "IP target, DNS is not required.",
		"conn_dns_failed":             "DNS lookup failed.",
		"conn_dns_ok":                 "Resolved to %s.",
		"conn_dns_fake_ip":            "Resolved into 198.18.0.0/15 fake-IP, usually proxy DNS/TUN capture.",
		"conn_tcp_failed":             "TCP connection failed.",
		"conn_tcp_ok":                 "TCP connection to %s succeeded.",
		"conn_http_blocked_by_dns":    "DNS failed, so HTTP cannot continue.",
		"conn_http_skipped":           "This target is not an HTTP probe target.",
		"conn_http_failed":            "HTTP/HTTPS probe failed.",
		"conn_http_ok":                "HTTP probe to %s succeeded.",
		"conn_path_timeout":           "Path probe timed out.",
		"conn_path_no_gateway":        "No default gateway detected.",
		"conn_path_gateway":           "Target is the current default gateway.",
		"conn_path_route_probe":       "Trace is limited and degraded to route probe; default exit is %s.",
		"conn_conclusion_fake_ip":     "Proxy Fake-IP/TUN capture detected. This is the proxy virtual exit, not the target's public route.",
		"conn_conclusion_gateway":     "Default gateway is missing or unavailable. Check Wi-Fi/Ethernet, DHCP, and gateway configuration first.",
		"conn_conclusion_dns":         "DNS failed. Check DNS servers, proxy DNS, or captive portal state.",
		"conn_conclusion_tcp":         "TCP failed. Routing, firewall, proxy, or the target service may be blocking the connection.",
		"conn_conclusion_http":        "TCP works but HTTP failed. The website, proxy policy, TLS interception, or HTTP status may be the issue.",
		"conn_conclusion_route_probe": "Basic connectivity works. Trace degraded to route probe, so only exit selection and port reachability are confirmed.",
		"conn_conclusion_ok":          "Connectivity looks normal.",
		"conn_conclusion_regional":    "Domestic target works but global targets fail. Check proxy rules, international exit, DNS pollution, or ISP restrictions.",
		"conn_summary_ok":             "Connectivity matrix found no obvious issues.",
		"conn_summary_warning":        "Connectivity matrix found %d targets needing attention.",
		"conn_summary_danger":         "Connectivity matrix found %d unreachable targets.",
		"report_title":                "RoutePeek Troubleshooting Package",
		"report_version":              "Version",
		"report_generated":            "Generated at",
		"report_redaction":            "Redaction",
		"report_redaction_note":       "MAC addresses are hidden, proxy credentials are removed, and private IPs are partially masked; public IP is retained to identify the network exit.",
		"report_sensitive_warning":    "Before sharing, review whether public IP, adapter names, proxy addresses, VPN names, or similar fields are sensitive.",
		"report_health":               "Health Summary",
		"report_status":               "Status",
		"report_summary":              "Summary",
		"report_primary_issue":        "Primary issue",
		"report_first_advice":         "First advice",
		"report_network_state":        "Key Network State",
		"report_gateway":              "Default gateway",
		"report_public_ip":            "Public IP",
		"report_proxy":                "Proxy",
		"report_connectivity":         "Connectivity Matrix",
		"report_target":               "Target",
		"report_path":                 "Path",
		"report_conclusion":           "Conclusion",
		"report_findings":             "Diagnostic Findings",
		"report_no_findings":          "No diagnostic findings.",
		"report_redaction_title":      "Redaction Notes",
		"report_empty":                "Not detected",
		"report_on":                   "On",
		"report_off":                  "Off",
	},
}
